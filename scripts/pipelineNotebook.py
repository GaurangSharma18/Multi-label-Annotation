...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_file", help="Path to JSON file containing labels.", type=str)
    ...
    list_augmentations_file = args.list_augmentations_file
    output_folder = args.output_folder

    hasKeypoints = args.hasKeypoints
    hasBBox = args.hasBBox
    hasSeg = args.hasSeg
